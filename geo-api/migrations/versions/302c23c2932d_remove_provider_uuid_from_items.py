...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('items', sa.Column('provider_uuid', postgresql.UUID(), autoincrement=False, nullable=False))
    op.create_foreign_key('items_provider_uuid_fkey', 'items', 'providers', ['provider_uuid'], ['uuid'])
