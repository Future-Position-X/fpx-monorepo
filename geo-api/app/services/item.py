...
def get_items_within_bounding_box_as_geojson(collection_uuid, minx, miny, maxx, maxy):
    with ItemStore() as item_store:
        items = item_store.find_within_bounding_box_as_geojson(collection_uuid, minx, miny, maxx, maxy)
        item_store.complete()
        return items
