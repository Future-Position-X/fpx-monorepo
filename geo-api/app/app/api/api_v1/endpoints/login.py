...
@router.post("/password-recovery/{email}/{new_password}", response_model=schemas.Msg)
def recover_password(
    ...
    password_reset_token = generate_password_reset_token(email=email, password=new_password)
    send_reset_password_email(
