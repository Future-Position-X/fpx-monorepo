...
@router.post("/password-recovery/{email}/{password}", response_model=schemas.Msg)
def recover_password(
    email: str, password: str, db: Session = Depends(deps.get_db)
) -> Any:
    """
    Password Recovery
    """
    ...
    password_reset_token = generate_password_reset_token(email=email, password=password)
    send_reset_password_email(
