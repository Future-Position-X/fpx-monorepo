...
from shapely.geometry import shape, mapping, GeometryCollection, LineString
...
class PolygonEnvironment:
    ...
    def add_geometry(self, geometry):
        normalized_poly = []
        coords = geometry.exterior.coords if type(geometry) is Polygon else geometry.coords
        for point in coords:
